...
function Navbar() {
  return (
    <div
      className="w-screen h-16 sm:h-20 text-blue-300 flex p-1 sm:p-9 items-center justify-between text-nav sm:text-xl font-light mb-40 fixed top-0 z-10"
      style={{
        background: "linear-gradient(to right, #0f2027, #203a43, #2c5364)",
      }}
    >
      <div className="text-4xl sm:text-6xl font-semibold m-1 sm:m-0 sm:hidd text-yellow-100 mr-10">
        <a href="/">S.</a>
      </div>
