...
function Navbar() {
  return (
    <div
      className="w-screen h-16 sm:h-20 text-blue-300 flex p-2 sm:p-9 items-center justify-between text-xl font-light mb-40 fixed top-0 z-10"
      style={{
    ...
    >
      ...
      <div className="flex w-96 sm:w-96 cursor-pointer justify-evenly sm:ml-0">
