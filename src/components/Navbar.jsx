...
function Navbar() {
  return (
    <div
      className="w-screen h-20 text-blue-300 flex p-9 items-center justify-between text-xl font-light mb-40 fixed top-0 z-10"
      style={{
        background: "linear-gradient(to right, #0f2027, #203a43, #2c5364)",
      }}
    >
      <div className="text-6xl font-semibold m-1 sm:hidd text-yellow-100">
        <a href="/">S.</a>
      </div>
